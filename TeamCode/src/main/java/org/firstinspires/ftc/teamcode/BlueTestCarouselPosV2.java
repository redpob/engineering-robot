...
@TeleOp
public class BlueTestCarouselPosV2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("math of distance right: ", String.format("%f in", (sensorDistanceR.getDistance(DistanceUnit.INCH) - 9)/20));
            ...
            if((sensorDistanceR.getDistance(DistanceUnit.INCH) >= 9) || (sensorDistanceB.getDistance(DistanceUnit.INCH) >= 10)) {
                drive.drive((sensorDistanceR.getDistance(DistanceUnit.INCH) - 9) / 20, -(sensorDistanceB.getDistance(DistanceUnit.INCH) - 10)/20, 0);
            }
            if(((sensorDistanceR.getDistance(DistanceUnit.INCH) > 9) && (sensorDistanceR.getDistance(DistanceUnit.INCH) < 11)) &&
        ...
        while(opModeIsActive()){
            ...
            if (angles.firstAngle > (startTurning - 40)) {
                angles   = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
